...
export default function TournamentBracket() {
  return (
    <div id="bracketTree" className="bg-[var(--bg-card)] shadow-[var(--neu-flat)] border border-[var(--border-subtle)] rounded-3xl p-5 sm:p-8 hud-corners w-full">
      ...
      <div className="flex items-center justify-between mb-6 sm:mb-8 flex-wrap gap-4">
        <div>
          ...
          <p className="text-xs text-[var(--text-muted)] font-mono">
            Eliminación directa · Servidor Santiago de Chile · Formato Bo1 / Final Bo3
          </p>
        </div>
      ...
      <div className="md:hidden flex items-center gap-1.5 text-[11px] font-mono text-[var(--text-muted)] mb-3">
        <svg className="w-3.5 h-3.5 text-[var(--primary)] flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <polyline points="9 18 15 12 9 6"></polyline>
        </svg>
        <span>Desliza horizontalmente para explorar todas las fases</span>
      </div>

      {/* Árbol de Brackets con Scroll Táctil Seguro en Móviles */}
      <div className="touch-scroll-bracket pb-4 w-full">
        <div className="min-w-[700px] grid grid-cols-3 gap-8 items-center">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-[var(--bg-sunken)] p-4 rounded-2xl border border-[var(--accent-mint)]/50 shadow-[var(--neu-floating)] flex flex-col gap-2 text-xs">
